...
---
If Pull Request is accepted, our changes will be merged into the main repository (upstream). And remember, we can always verify that our fork has the latest changes of the upstream (steps 3 and 4):
